    ...
    <footer className="bg-[#1a1a1a] text-white mt-20">
      <div className="max-w-[1200px] mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Brand */}
          <div>
            <p className="text-[#2d6a4f] font-bold text-2xl mb-2">KitUp</p>
          ...
          {/* Links */}
          <div>
            <p className="font-semibold mb-4 text-white">Explore</p>
            <ul className="flex flex-col gap-2 text-[#888888] text-sm">
              <li>
                <Link href="/#hobbies" className="hover:text-white transition-colors">
                  Hobbies
                </Link>
              </li>
              <li>
